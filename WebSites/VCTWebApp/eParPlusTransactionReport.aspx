<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="eParPlusTransactionReport.aspx.cs"
    Inherits="VCTWebApp.Shell.Views.eParPlusTransactionReport" Title="Transaction Report"
...
<asp:Content ID="Content2" ContentPlaceHolderID="DefaultContent" runat="server">
    ...
    <script type="text/javascript">
        ...
        $(function () {
            ...
            function fixedGrid() {
                InitGridEvent('<%= gdvTransaction.ClientID %>');
            }
                            ...
                            <caption>
                                ...
                                <tr class="header">
                                    <td align="center" colspan="2">
                                        <asp:Label ID="lblHeader" runat="server" Text="Transaction Report"></asp:Label>
                                    </td>
                                </tr>
                                <tr>
                                        ...
                                        <asp:Panel ID="pnlProductSection" runat="server" GroupingText="Product" HorizontalAlign="Left"
                                            ...
                                            <table>
                                                ...
                                                <tr>
                                                    ...
                                                    <td align="center" style="width: 125px">
                                                        <asp:DropDownList ID="ddlTransaction" runat="server" AutoPostBack="True" CssClass="ListBox"
                                                            Width="110px">
                                                        </asp:DropDownList>
                                                    </td>
                                                    <td align="center" style="width: 125px">
                                ...
                                <tr>
                                    <td align="center" valign="top" colspan="2">
                                        <asp:Panel ID="pnlGrid" runat="server" CssClass="pnlGrid" Height="310px" ScrollBars="Auto"
                                            Width="99%">
                                            <asp:GridView ID="gdvTransaction" runat="server" AutoGenerateColumns="false" ShowHeaderWhenEmpty="false"
                                                SkinID="GridView" Width="99%" OnRowDataBound="gdvTransaction_RowDataBound" OnSorting="gdvTransaction_Sorting"
                                                AllowSorting="true">
                                                <Columns>
                                                                            ...
                                                                            <ItemTemplate>
                                                                                ...
                                                                                <asp:Panel ID="pnlChild2" runat="server" Style="display: none">
                                                                                    <asp:GridView ID="grdChild2" runat="server" AutoGenerateColumns="false" SkinID="GridView"
                                                                                        OnRowDataBound="grdChild2_RowDataBound">
                                                                                        <Columns>
                                                                                            ...
                                                                                            <asp:BoundField DataField="StatusDescription" HeaderStyle-Width="60%" ItemStyle-Width="60%"
                                                                                                HeaderText="Transaction" ItemStyle-HorizontalAlign="Center" />
                                                                                            <asp:BoundField DataField="UpdatedOn" HeaderStyle-Width="40%" ItemStyle-Width="40%"
                                                                                                HeaderText="Updated On" ItemStyle-HorizontalAlign="Center" />
                                                                                        </Columns>
                                                                                    </asp:GridView>
                                                                                </asp:Panel>
                                                                            </ItemTemplate>
                                                                        </asp:TemplateField>
                                                                        <asp:BoundField DataField="RefNum" HeaderStyle-Width="10%" ItemStyle-Width="10%"
                                                                            HeaderText="Ref #" ItemStyle-HorizontalAlign="Center" SortExpression="RefNum" />
                                                                        <asp:BoundField DataField="PartDesc" HeaderStyle-Width="30%" ItemStyle-Width="30%"
                                                                            HeaderText="Description" ItemStyle-HorizontalAlign="Center" SortExpression="PartDesc" />
                                                                        <asp:BoundField DataField="LotNum" HeaderStyle-Width="15%" ItemStyle-Width="15%"
                                                                            HeaderText="Lot Num" ItemStyle-HorizontalAlign="Center" SortExpression="LotNum" />
                                                                        <asp:BoundField DataField="TagId" HeaderStyle-Width="30%" ItemStyle-Width="30%" HeaderText="RFID Tag Id"
                                                                            ItemStyle-HorizontalAlign="Center" SortExpression="TagId" />
                                                                        <asp:BoundField DataField="Count" HeaderStyle-Width="30%" ItemStyle-Width="30%" HeaderText="Total Transactions"
                                                                            ItemStyle-HorizontalAlign="Center" SortExpression="Count" />
                                                                    </Columns>
                                                                </asp:GridView>
                                                            </asp:Panel>
                                                        </ItemTemplate>
