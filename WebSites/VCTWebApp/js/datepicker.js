...
var WeekHeadColor = "#a5bfe1"; //var WeekHeadColor="#18861B";//Background Color in Week header.
var SundayColor = "#93afd3"; //var SundayColor="#C0F64F";//Background color of Sunday.
var SaturdayColor = "#93afd3"; //Background color of Saturday.
var WeekDayColor = "#ffffff"; //Background color of weekdays.
var FontColor = "#000000"; //color of font in Calendar day cell.
var TodayColor = "#a5bfe1"; //var TodayColor="#FFFF33";//Background color of today.
var SelDateColor = "#8DD53C"; //var SelDateColor="#8DD53C";//Backgrond color of selected date in textbox.
var YrSelColor = "#cc0033"; //color of font of Year selector.
var MthSelColor = "#cc0033"; //color of font of Month selector if "MonthSelector" is "arrow".
var HoverColor = "#7897bf"; //color when mouse move over.
var DisableColor = "#C4B11F"; //color of disabled cell.
var ThemeBg = "../Images/cal-bg.gif"; //Background image of Calendar window.
var CalBgColor = "#e3efff"; //Background color of Calendar window.
...
function RenderCssCal(bNewCal) {
	...
	vCalHeader = "<table " + CalBgColor + " background='" + ThemeBg + "' border=0 cellpadding=1 cellspacing=1 width='200px' valign='top' style='border:0px solid #ffffff;'>\n";
  ...
  //******************End Month and Year selector in arrow******************************
	...
	if (winCal == undefined) {
     ...
     // add javascript function to the span cal
       ...
       with (span.style) {position = "absolute"; left = (xpos+8)+'px'; top = '185px'; width = CalWidth+'px'; border = "solid 2pt " + SpanBorderColor; padding = "0pt"; cursor = "move"; backgroundColor = SpanBgColor; zIndex = 100;}
