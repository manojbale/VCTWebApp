...
{
    public class eParPlusConsumptionRateReportPresenter : Presenter<IeParPlusConsumptionRateReport>
    {
        ...
        public eParPlusConsumptionRateReportPresenter()
            : this(new CustomerRepository(HttpContext.Current.User.Identity.Name))
        {
        }

        public eParPlusConsumptionRateReportPresenter(CustomerRepository customerRepository)
        {
            helper.LogInformation(HttpContext.Current.User.Identity.Name, "eParPlusConsumptionRateReportPresenter", "Constructor is invoked.");
        ...
        public List<ConsumptionRate> PopulateReport()
        {
            List<ConsumptionRate> ListReportData = eParPlusRepositoryService.FetchConsumptionRateReport
            ...
            View.ListConsumptionRate = ListReportData;
