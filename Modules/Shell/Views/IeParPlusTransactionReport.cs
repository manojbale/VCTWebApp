...
{
    [CLSCompliant(true)]
    public interface IeParPlusTransactionReport
    {
        List<EPPTransaction> ListEPPTransaction { set; }
        ...
        DateTime SelectedStartDate { get; }
        DateTime SelectedEndDate { get; }
        string SelectedItemStatus { get; }
    }
}
