...
{
    public class eParPlusTransactionReportPresenter : Presenter<IeParPlusTransactionReport>
    {
        ...
        public eParPlusTransactionReportPresenter()
            : this(new CustomerRepository(HttpContext.Current.User.Identity.Name))
        {
        }

        public eParPlusTransactionReportPresenter(CustomerRepository customerRepository)
        {
            helper.LogInformation(HttpContext.Current.User.Identity.Name, "eParPlusTransactionReportPresenter", "Constructor is invoked.");
        ...
        public List<EPPTransaction> PopulateReport()
        {
            List<EPPTransaction> ListReportData=  eParPlusRepositoryService.FetchTransactionReport
                   (View.SelectedCustomerAccountFilter, View.SelectedStateFilter, View.SelectedOwnershipStructureFilter,
                       ...
                       View.SelectedProductLineFilter, View.SelectedCategoryFilter, View.SelectedSubCategory1Filter, View.SelectedSubCategory2Filter, View.SelectedSubCategory3Filter, View.SelectedStartDate, View.SelectedEndDate, View.SelectedItemStatus, HttpContext.Current.User.Identity.Name);
            View.ListEPPTransaction = ListReportData;
