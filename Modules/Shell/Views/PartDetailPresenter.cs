...
{
    public class PartDetailPresenter : Presenter<IPartDetailView>
    {
        ...
        {
            View.PartDetailStockLevelList = new KitFamilyRepository().GetPartDetailStockLevelByLocationAndPart(locationId, partNum);
        }
    }
}
