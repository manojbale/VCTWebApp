    ...
    public class SafeDataReader : IDataReader
    {
        ...
        public virtual DateTime GetDateTime(int i)
        {
            if (_dataReader.IsDBNull(i))
                ...
                return ConvertUTCToLocalDateTime(_dataReader.GetDateTime(i));  //.ToLocalTime();
                //return _dataReader.GetDateTime(i);  //.ToLocalTime();
        }
        ...
        /// </remarks>
        /// <param name="name">Name of the column containing the value.</param>
        public virtual DateTime GetLocalDateTime(string name)
        {
            return GetLocalDateTime(_dataReader.GetOrdinal(name));
        }
        ...
        /// </remarks>
        /// <param name="i">Ordinal column position of the value.</param>
        public virtual DateTime GetLocalDateTime(int i)
        {
            if (_dataReader.IsDBNull(i))
                return DateTime.MinValue;
            else
        ...
        private DateTime ConvertUTCToLocalDateTime(DateTime uTCDateTime)
        {
            ...
            if ((System.Web.HttpContext.Current.Session != null) && (System.Web.HttpContext.Current.Session["TimeZoneOffset"] != null))
            {
                ...
                localDateTime = uTCDateTime.AddMinutes(0 - timeZoneOffset);
            }
        ...
        /// <returns>Int64 value for the given value.</returns>
        ...
        /// <param name="name">The name.</param>
        /// <returns></returns>
        public Int16? GetNullableInt16(string name)
        {
            if (this._dataReader.IsDBNull(this._dataReader.GetOrdinal(name)))
                return null;
            else
                return GetInt16(_dataReader.GetOrdinal(name));
        }
        ...
        /// </summary>
        /// <param name="name">The name.</param>
        /// <returns>DateTime value for the given datetime.</returns>
        public DateTime GetNullableDateTime(string name)
        {
            return GetDateTime(_dataReader.GetOrdinal(name));
        }

        public DateTime? GetNewNullableDateTime(string name)
        {
            if (this._dataReader.IsDBNull(this._dataReader.GetOrdinal(name)))
                return null;
            else
